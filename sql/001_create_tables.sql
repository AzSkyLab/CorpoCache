...
CREATE TABLE Users (
    id NVARCHAR(255) PRIMARY KEY,  -- Azure Static Web Apps user ID
    email NVARCHAR(255),
...
CREATE TABLE CreditCards (
    ...
    custom_image NVARCHAR(100),  -- Credit card company identifier
    created_at DATETIME2 DEFAULT GETUTCDATE(),
    updated_at DATETIME2 DEFAULT GETUTCDATE(),
...
CREATE TABLE Bills (
    ...
    due_date INT NOT NULL,  -- Day of month (1-31)
    type NVARCHAR(20) NOT NULL DEFAULT 'normal',  -- 'normal', 'credit', 'loan'
    priority NVARCHAR(20) DEFAULT 'normal',  -- 'low', 'normal', 'high'
    is_paid BIT DEFAULT 0,
    varying_amount BIT DEFAULT 0,
    auto_pay BIT DEFAULT 0,
    payment_account NVARCHAR(20),  -- 'checking', 'savings', or NULL
...
CREATE TABLE Loans (
    ...
    due_date INT NOT NULL,  -- Day of month (1-31)
    type NVARCHAR(20) NOT NULL,  -- 'car', 'personal', 'mortgage', 'student'
...
CREATE TABLE SalaryData (
    ...
    -- Input values (stored as numbers for calculations)
    annual_salary DECIMAL(14,2),
    pay_frequency INT,  -- 26 for bi-weekly, 24 for semi-monthly
    filing_status NVARCHAR(20),  -- 'single', 'married', 'head'
    ...
    -- Date fields
    last_pay_date DATE,  -- For bi-weekly
    first_pay_date DATE,  -- For semi-monthly
...
CREATE TABLE ProfitData (
    ...
    -- Status indicators
    profit_ratio DECIMAL(6,2),  -- Percentage value
    pay_frequency INT,
    created_at DATETIME2 DEFAULT GETUTCDATE(),
    updated_at DATETIME2 DEFAULT GETUTCDATE(),
...
CREATE TABLE HistoricalBillItems (
    ...
    name NVARCHAR(255) NOT NULL,
    amount DECIMAL(12,2) NOT NULL,
    type NVARCHAR(20) NOT NULL,  -- 'normal', 'credit', 'loan'
    due_date INT NOT NULL,
    is_paid BIT NOT NULL DEFAULT 0,
    payment_account NVARCHAR(20),
